...
## List of item numbers and their costs in seals in a dictionary
items_seals = {
    4567: 1710,
    4568: 1010,
    15855: 500,
...
def api_grab(item_num):
    api_url = ("https://universalis.app/api/Aether/" + str(item_num))          ## Change Aether to you own data centre
...
def search_best_seals():
    ...
    while i < len(key_list_seals):
         ...
         item_list2[int(item_num)] = round(world_price / key_list_seals_price[i], 2)
         i = i + 1
    i = 0
...
def search_best_poetics():
    ...
    while i < len(key_list_poetics):
        ...
        world_price = api_grab(item_num)
        item_list[int(item_num)] = round(world_price / key_list_poetics_price[i], 2)
        i = i + 1
    i = 0
    ...
    T.insert(tk.END, ("\nThe best value poetics in order: "))
